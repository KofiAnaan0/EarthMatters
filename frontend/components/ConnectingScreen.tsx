...
export const ConnectingScreen = () => {
	return (
		...
		>
			...
			{/* Content Container */}
			<div className="relative z-10 flex flex-col items-center backdrop-blur-xl bg-white/10 border border-white/20 rounded-2xl p-8 shadow-2xl max-w-lg mx-auto">
